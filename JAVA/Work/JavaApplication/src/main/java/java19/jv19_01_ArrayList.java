...
public class jv19_01_ArrayList {
    ...
    public static void main(String[] args) {
        ...
        list = new ArrayList<>(); //String [] arr = new String[10];        
...
//        list = new Vector<String>();
         ...
         * "BREAD" 가 들어있는 방번호 찾기
         * */
        list.set(2,"GRAPE");  //2번방 BREAD를 GRAPE로..
         ...
         * */
        System.out.println();
        System.out.print("list, for-each문 출력: ");
        ...
        System.out.println("S: 검색 APPLE 첫방번호 >> "+pos);

        /* S: 오름차순 정렬. 검색: "자바 ArrayList 오름차순 정렬"
         */
        Collections.sort(list);
        System.out.println("S: 오름차순 sort >> "+list.toString());

        /* S: 내림차순 정렬. 검색: "자바 ArrayList 내림차순 정렬"
         */
        Collections.reverse(list);
        System.out.println("S: 내림차순 sort >> "+list.toString());
        ...
        System.out.println("S: APPLE은 몇개? >> "+cnt);

        /* ArrayList 배열로 변환하시오.  toArray() 사용
         * "자바 ArrayList 배열 변환 검색"
         * */
        String[] sary = list.toArray(new String[list.size()]);

        /* 변환된 배열을 for 문으로 출력.
         */
        System.out.print("P: 변환 결과 for문 출력: ");
        for (int i=0; i<sary.length; i=i+1) {
         ...
         */
        System.out.print("P: 변환 결과 for-each문 출력: "  );
        for (String val : sary) {
